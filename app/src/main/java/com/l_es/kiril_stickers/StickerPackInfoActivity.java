...
public class StickerPackInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String trayIconUriString = getIntent().getStringExtra(Utilities.EXTRA_STICKER_PACK_TRAY_ICON);
        final String website = getIntent().getStringExtra(Utilities.EXTRA_STICKER_PACK_WEBSITE);
        final String email = getIntent().getStringExtra(Utilities.EXTRA_STICKER_PACK_EMAIL);
        final String privacyPolicy = getIntent().getStringExtra(Utilities.EXTRA_STICKER_PACK_PRIVACY_POLICY);
        final String licenseAgreement = getIntent().getStringExtra(Utilities.EXTRA_STICKER_PACK_LICENSE_AGREEMENT);
